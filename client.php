  ...
  <div id="container" >
    ...
    <div id="setup_server" >
      <fieldset >
        ...
        <input type="text" id="host" placeholder="Enter Host ( IP or Domain name only )" />:<input type="text" id="port" placeholder="Enter Port" />
        <button id="setup" >Connect to Server</button >
      </fieldset >
    </div >
    <div id="websocket" >
      <table border="0" >
        <tr >
          <td ><h4 >Send Data</h4 >
            ...
            <div id="send_data" class="data-box" ></div >
          </td >
          <td ><h4 >Receive Data</h4 >

            <div id="receive_data" class="data-box" ></div >
          </td >
        </tr >
      </table >
      <!-- #chatLog -->
